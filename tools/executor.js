...
import { repairPerformanceData } from "./repair.js";
...
const toolMap = {
  ...
  repair_performance: async ({ dry_run = false, pool_filter = null } = {}) => {
    try {
      const result = await repairPerformanceData({ dryRun: dry_run, poolFilter: pool_filter });
