...
- Strategy: omit the strategy field — the system will use the configured default from config.strategy.strategy. Supported values: bid_ask, spot, or mixed.
      ...
      parameters: {
        ...
        properties: {
          ...
          strategy: {
            ...
            description: "DLMM strategy type. 'mixed' means 30% Spot first, then 70% BidAsk into the same position. If user specifies, use exactly what they said. Otherwise omit — the system default from config.strategy.strategy will be used automatically."
          },
          bins_below: {
            type: "number",
